...
const cards = [
  ['Stage 1', 'Intake & Upload', '/dashboard/procurement/intake', FileUp],
  ['Stage 2/3', 'BOM Review', '/dashboard/procurement/bom/11223344-5566-7788-99aa-bbccddeeff00', Boxes],
  ['Stage 4', 'Inventory Check', '/dashboard/procurement/inventory', Warehouse],
  ['Stage 5', 'Purchase Orders', '/dashboard/procurement/po', ShoppingCart],
  ['Production', 'Production Board', '/dashboard/procurement/production', Factory]
];
  ...
  return (
    <div className="space-y-7 max-w-6xl mx-auto pb-12">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <Metric title="POs" value={data?.po?.count || 0} />
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        <Link href="/dashboard/procurement/notifications" className="px-4 py-2.5 rounded-xl border text-xs font-black">
          <Bell className="w-4 h-4 inline mr-2" />
          Notifications
        </Link>
        <Link href="/dashboard/procurement/chat" className="px-4 py-2.5 rounded-xl border text-xs font-black">
          <MessageCircle className="w-4 h-4 inline mr-2" />
          Factory Chat
        </Link>
        <Link href="/dashboard/procurement/production" className="px-4 py-2.5 rounded-xl bg-[#2d1f0e] text-white text-xs font-black">
          <Factory className="w-4 h-4 inline mr-2" />
          Open Production Board
        </Link>
        <Link href="/dashboard/procurement/intake" className="px-4 py-2.5 rounded-xl bg-[#c8834a] text-white text-xs font-black">
