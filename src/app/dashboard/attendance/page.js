...
function MyAttendanceView({ token }) {
  ...
  return (
    <motion.div variants={staggerContainer} initial="show" animate="show" className="space-y-6">
      <div>
            ...
            <>
              ...
              <div className="hidden sm:block overflow-x-auto rounded-xl" style={{ border: '1px solid rgba(200,131,74,0.15)' }}>
                <table className="w-full text-left text-xs font-semibold">
                  ...
                  <motion.tbody variants={rowStagger} initial="show" animate="show" className="divide-y" style={{ divideColor: 'rgba(200,131,74,0.1)', color: '#2d1f0e' }}>
                    {paginated.map((row) => (
              ...
              <motion.div variants={staggerContainer} initial="show" animate="show" className="sm:hidden space-y-3">
                {paginated.map((row) => (
        ...
        {filtered.length === 0 ? (
          ...
          <div className="overflow-x-auto rounded-xl" style={{ border: '1px solid rgba(200,131,74,0.15)' }}>
            <table className="w-full text-left text-xs font-semibold">
              ...
              <motion.tbody variants={rowStagger} initial="show" animate="show" className="divide-y" style={{ divideColor: 'rgba(200,131,74,0.1)' }}>
                {filtered.map((w) => {
