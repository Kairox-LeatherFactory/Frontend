  ...
  return (
    <div>
      ...
      {historyLoading ? (
        ...
        <motion.div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))' }} variants={staggerContainer} initial="show" animate="show">
          {filteredRows.map((r) => {
      ...
      {historyLoading ? (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <motion.tbody variants={staggerContainer} initial="show" animate="show">
              {rows.map((r) => (
      ...
      {!selectedOrderId ? (
        ...
        <>
          ...
          <AnimatePresence mode="wait">
            <motion.div key={activeTab} variants={tabFade} initial="show" animate="show" exit="exit">
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        {generatedBarcodes.length === 0 ? (
          ...
          <motion.div className="grid gap-4" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))' }} variants={staggerContainer} initial="show" animate="show">
...
export default function BarcodeManagementPage() {
  ...
  return (
    <motion.div className="space-y-6" variants={staggerContainer} initial="show" animate="show">
      <style jsx global>{`
        .btn-warm-primary {
      ...
      {category !== 'style' && (
        <AnimatePresence mode="wait">
          <motion.div key={`${category}-${activeTab}`} variants={tabFade} initial="show" animate="show" exit="exit">
