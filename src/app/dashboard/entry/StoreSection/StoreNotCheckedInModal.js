// worker not checked in code
'use client';
import { createPortal } from 'react-dom';
import { useRouter } from 'next/navigation';
import { AlertTriangle } from 'lucide-react';

export default function StoreNotCheckedInModal({ mounted, barcodeNotCheckedInModal, setBarcodeNotCheckedInModal, workerInputRef }) {
  const router = useRouter();
  if (!mounted || !barcodeNotCheckedInModal) return null;
