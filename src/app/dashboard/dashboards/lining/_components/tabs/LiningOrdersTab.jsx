...
/**
 * ============================================================================
 * LiningOrdersTab Component
 * ============================================================================
 */
export default function LiningOrdersTab({
  orderProgress = [],
  onSelectOrder,
}) {
  return (
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h3 className="text-base font-black text-slate-900 flex items-center gap-2">
              ...
              Lining Order &amp; Style Matrix
            </h3>
            <p className="text-xs text-slate-500 mt-0.5">
              Target cutting units vs minted lining piece completions
            </p>
          </div>
          ...
          <table className="w-full text-xs md:text-sm text-left">
            ...
            <tbody className="divide-y divide-slate-100 font-medium">
              {orderProgress.map((row, idx) => {
                ...
                return (
                  <tr
                    key={`order-lining-${row.order_id || row.order_number}-${idx}`}
